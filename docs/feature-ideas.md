...
### 2. Delete entries
There's currently no way to delete an entry - only edit. Sometimes you write something you want to remove entirely.

**Implementation:** Add `deleteEntry` server function + confirmation dialog. Cascade-delete related chat messages.

---

### 3. Streak record (all-time best)
...
### 5. Entry count milestone celebrations
...
### 6. Improved time-of-day greeting
...
### 14. Comparison view: this week vs last week
...
### 15. Entry for specific past dates (calendar picker)
...
### 16. Reading time & word count stats
...
### 25. Progressive Web App (PWA) with notifications
...
### 27. Seasonal & cyclical pattern detection
...
### 29. Multi-dimensional mood tracking
...
### 35. Customizable dashboard layout
...
### 38. Improved AI conversation starters
...
### 41. Database indexes for performance
