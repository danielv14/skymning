        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-2 focus:-outline-offset-2 focus:outline-emerald-500 focus:border-transparent"
              autoFocus
            />
          </div>
